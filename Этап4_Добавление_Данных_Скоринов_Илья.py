            ...
            while True:
                ...
                if choice == '💠 Выйти в меню':
                    ...
                    if len(notes) == 0:
                        ...
                        delete_note(notes)
                        display_notes(notes)
                elif choice == '🌀 Загрузить заметку':
                    try:
                        load_note = ast.literal_eval(load_notes_from_file())
...
def append_notes_to_file(notes):
    try:
